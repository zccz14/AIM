...
- Uses `aim-ask-strategy` as the broad pre-execution discovery entry when the next action is not yet clear, while the other packaged skills stay as direct workflow guides for task creation, README evaluation, spec verification, developer execution, and repo setup.
