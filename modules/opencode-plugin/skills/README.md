...
- `aim-developer-guide`: Required AIM Developer entry guidance for working an existing Task through AIM Server reading, baseline verification, worktree execution, PR follow-up, AIM reporting, and final resolve or reject handling.
