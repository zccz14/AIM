...
description: AIM Manager guidance for evaluating README goals against the latest baseline, defining iteration direction and coordinate systems, and preparing Markdown Manager Report content for server-side persistence without creating tasks or executing work.
---
