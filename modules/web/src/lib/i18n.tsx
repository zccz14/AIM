...
const messages = {
  en: {
    ...
    openCodeTokenCachedInput: "Cached input",
    openCodeTokenCacheWrites: "Cache writes",
    openCodeTokenInput: "Input",
    openCodeTokenOutput: "Output",
    openCodeTokenReasoning: "Reasoning",
    ...
    refreshUsageFailed: "Refresh usage failed",
    ...
    time: "Time",
    tokenUsageDetail: "Token usage detail",
