...
~~OpenCode 插件是注入 Skill 或者其他配置最干净的方式。~~ (现在 `npx skills` 是更方便、更通用的方式了。)
...
- AIM Skills 入口：[`.agents/skills`](.agents/skills)，通过 `npx skills add <aim_repo_url>` 从仓库直接安装。
...
安装 AIM Skills: `npx skills add <aim_repo_url>`
